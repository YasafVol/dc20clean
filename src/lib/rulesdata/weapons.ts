...
export const weaponsData: WeaponData[] = [
  ...
  },
  {
    ...
    specialNotes: 'Contested Physical Save. Success: Restrained and Grappled. Deal 1 Slashing to net to break free'
  },
  ...
  },
  {
    ...
    specialNotes: 'When Hidden: attack does not reveal position on miss/Heavy Hit. Does Poison damage'
  }
];

// Helper functions for weapon calculations
export const getWeaponAttackBonus = (weapon: WeaponData, combatMastery: number, primaryMod: number, secondaryMod?: number): number => {
...
export const getWeaponDamageBonus = (weapon: WeaponData, primaryMod: number, secondaryMod?: number): number => {
