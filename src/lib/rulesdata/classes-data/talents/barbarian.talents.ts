...
export const barbarianTalents: Talent[] = [
	{
		...
		category: 'Class',
		description:
			'While Raging, you can wield Two-Handed Weapons using only one hand. Your Jump Distance also increases by 1.',
		prerequisites: { classId: 'barbarian', feature: 'Rage', level: 3 },
		effects: [
			{
				type: 'GRANT_ABILITY',
				target: 'titan_grip',
				value: 'Wield Two-Handed weapons in one hand while Raging.'
			},
	...
	},
	{
		...
		effects: [
			{
				type: 'GRANT_ABILITY',
				target: 'quick_to_anger',
				value: 'Enter Rage as a reaction to Initiative.'
			},
			{
				type: 'GRANT_ABILITY',
				target: 'unstoppable_charge',
				value: 'Charge ignores Difficult Terrain and Opportunity Attacks.'
			}
		]
	}
];
