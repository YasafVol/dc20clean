...
export const warlockTalents: Talent[] = [
	...
	},
	{
		...
		category: 'Class',
		description:
			'You learn the Bane Spell. Creatures subjected to Bane suffer additional effects based on your chosen Pact Boon.',
	...
	},
	{
		...
		category: 'Class',
		description:
			'You can spend 1 minute to create a Warlock Subcontract with a willing creature, granting shared telepathy and allowing them to use Hasty Bargain. You can also spend their HP on your Warlock features.',
