...
export const wizardTalents: Talent[] = [
	{
		...
		category: 'Class',
		description:
			'Choose 1 additional Spell School. You learn 1 Arcane Cantrip and 1 Arcane Spell from this school, and can use Signature School once per chosen school.',
	...
	},
	{
		...
		category: 'Class',
		description:
			'When you create an Arcane Sigil, you can bind it to yourself. While bound, it moves with you and grants you a +2 bonus to your AD.',
	...
	},
	{
		...
		category: 'Class',
		description:
			'Your Prepared Spell can be changed on a Short Rest, grants Dazed Resistance while Sustaining, and you gain ADV on Spell Duels with it.',
