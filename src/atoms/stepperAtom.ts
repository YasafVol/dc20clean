...
export const stepperStepsAtom = atom<
	Array<{
		id: string | number;
		label?: string;
		status?: 'upcoming' | 'in-progress' | 'completed' | 'error';
	}>
>([]);
...
export const characterCreationStepsAtom = atom<
	Array<{ id: string; label: string; status?: 'upcoming' | 'in-progress' | 'completed' | 'error' }>
>([
