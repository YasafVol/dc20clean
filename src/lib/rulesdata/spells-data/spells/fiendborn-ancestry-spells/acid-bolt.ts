...
export const acidBolt: Spell = {
  ...
  effects: [
    { title: "Spell Attack", description: "You can make a Spell Check against the PD of a target within range. Hit: The target takes 2 Corrosion damage." }
  ],
  ...
  enhancements: [
    ...
    { type: "AP", cost: 1, name: "Corrode", description: "The target makes a Physical Save. Failure: Target becomes Hindered for 1 minute or until a creature (including itself) within 1 Space spends 1 AP to clear off the acid." }
  ]
};
