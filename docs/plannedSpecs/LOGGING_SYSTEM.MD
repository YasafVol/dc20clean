...
> **Status: Historical plan** – Product analytics is now owned by `docs/systems/ANALYTICS_SYSTEM.MD`. The Vercel Analytics direction below is superseded. Logger and Sentry work remain separate.
