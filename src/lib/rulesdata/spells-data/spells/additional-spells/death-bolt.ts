...
export const deathBolt: Spell = {
  ...
  effects: [
    { title: "Spell Attack", description: "You can make a Spell Check against the PD of a target within range. Hit: The target takes 2 Umbral damage." },
    { title: "Black Orb", description: "Black wispy magic swirls around your hands. Your touch send chills down the spine of creatures and make small plants wither. You can hold this dark energy in your hands for 1 minute." }
  ],
  ...
  enhancements: [
    ...
    { type: "AP", cost: 1, name: "Dampen Heal", description: "Creatures that take damage from this Spell can’t regain HP until the start of their next turn." }
  ]
};
