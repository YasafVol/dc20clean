...
- Persistence: Browser localStorage (default) and Convex cloud storage (optional)
  - Convex is enabled when `VITE_USE_CONVEX=true` and `VITE_CONVEX_URL` is configured
  - Migration notes: `docs/archive/CONVEX_MIGRATION.md`
