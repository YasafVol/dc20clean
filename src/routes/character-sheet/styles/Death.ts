...
export const StyledHealthStatus = styled.div<{ status: 'healthy' | 'bloodied' | 'well-bloodied' | 'deaths-door' | 'dead' }>`
  font-size: 0.8rem;
  font-weight: bold;
  ...
  color: ${props => {
    switch (props.status) {
      ...
      case 'bloodied': return '#f59e0b';
      case 'well-bloodied': return '#f97316';
      case 'deaths-door': return '#dc2626';
  ...
  background: ${props => {
    switch (props.status) {
      ...
      case 'bloodied': return '#fef3c7';
      case 'well-bloodied': return '#fed7aa';
      case 'deaths-door': return '#fecaca';
