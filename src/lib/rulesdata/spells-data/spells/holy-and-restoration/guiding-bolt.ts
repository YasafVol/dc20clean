...
export const guidingBolt: Spell = {
  ...
  effects: [
    { title: "Flash of Light", description: "A flash of light streaks toward a creature of your choice within range, surrounding them in a holy glow. Make a Spell Check against the target’s PD. Hit: The target takes 3 Radiant damage and the next Attack Check made against the target before the end of your next turn has ADV." }
  ],
  enhancements: [
    { type: "MP", cost: 1, name: "Guiding Damage", description: "The next Attack Check made against the target also deals an extra 3 Radiant damage on a Hit." }
  ]
};
