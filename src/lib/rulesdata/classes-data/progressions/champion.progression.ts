/**
 * DC20 v0.10 Champion Class Progression
 *
 * Champion is a Martial class using the martial template.
 *
...
export const championProgression: ClassProgressionLevel[] = [
	...
	},
	{
		...
		gains: {
			...
			classFeatures: ['champion_adaptive_tactics']
		}
	},
	{
		level: 3,
	...
	},
	{
		...
		gainedSpellsKnown: 0,
		gains: {
			classFeatures: ['champion_level_5_placeholder']
		}
	},
	{
		level: 6,
	...
	},
	{
		...
		gains: {
			pathProgression: true,
			classFeatures: ['champion_level_8_capstone_placeholder']
		}
	},
	{
		level: 9,
