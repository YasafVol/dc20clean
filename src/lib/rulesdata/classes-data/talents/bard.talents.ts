...
export const bardTalents: Talent[] = [
	{
		...
		category: 'Class',
		description:
			'You gain 2 Skill Points, learn 2 Spells from any Spell List, and gain another manner of Magical Expression (Auditory or Visual).',
	...
	},
	{
		...
		effects: [
			{
				type: 'GRANT_ABILITY',
				target: 'helping_hands',
				value: 'Once per round, grant a second d8 Help Die to a different creature.'
			}
		]
	}
];
