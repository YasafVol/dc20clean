...
- All Systems
- Calculation Integration (focused dependency map around calculator pipeline)
...
- Hover a node to see tooltip details:
  - system title
  - purpose summary
  - how-it-works bullets (when available)
  - integration summary bullets (when available)
  - related system list
  - doc path
  - last-updated date
...
- Explorer canvas remains full-page width.
- Title/info overlay container is constrained to roughly half-page width on desktop.
- On smaller viewports, the title/info container expands to full width for usability.
