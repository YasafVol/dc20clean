...
export const poisonBolt: Spell = {
  ...
  effects: [
    { title: "Spell Attack", description: "You can make a Spell Check against the PD of a target within range. Hit: The target takes 2 Poison damage." }
  ],
  ...
  enhancements: [
    ...
    { type: "AP", cost: 1, name: "Sicken", description: "The target makes a Physical Save. Failure: Target becomes Impaired for 1 minute. A creature within 1 Space, including itself, can spend 1 AP to make a DC 10 Medicine Check to end the Condition early." }
  ]
};
