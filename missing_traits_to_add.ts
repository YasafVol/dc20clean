	...
	},
	{
		...
		effects: [
		   {
		      "type": "MODIFY_AP_WHILE_DEATHS_DOOR",
		      "value": 1
		   }
		]
	},
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Intimidating_Shout_OncePerCombat_1AP"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Move_As_Minor_Action_OncePerCombat_Toward_Enemy"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Force_New_Target_OncePerCombat_Reaction"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_DISADV_ON_CHECKS_SAVES_VS_CONDITION",
		      "target": "Taunted"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ADV_ON_INTIMIDATION_CHECKS_VS_REPTILIAN_MEDIUM_SMALL"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Draconic_Breath_Weapon_TwicePerCombat"
		   },
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Draconic_Breath_Weapon_Enhanced_Damage_Spend_Uses"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Draconic_Breath_Weapon_Concussive_Push"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Draconic_Breath_Weapon_Reaction_On_Deaths_Door"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_TEMP_HP_ONCE_PER_COMBAT_ON_DEATHS_DOOR",
		      "value": 2
		   },
		   {
		      "type": "GRANT_DAMAGE_ON_MELEE_HIT_WHILE_TEMP_HP",
		      "target": "Draconic_damage_type",
		      "value": 1
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Increase_PD_AD_Ally_On_Deaths_Door"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "TAKE_TRUE_DAMAGE_ONCE_PER_COMBAT_WHEN_ALLY_DEATHS_DOOR",
		      "value": "Prime_Modifier"
		   }
		]
	},
	{
		...
		effects: [
		   ...
		   {
		      "type": "MODIFY_SPACE_OCCUPIED",
		      "target": "1_Size_Smaller"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "target": "manual_review_needed",
		      "value": "[{ type: 'REDUCE_DAMAGE_TAKEN', value: 1, condition: 'deaths_door' }]"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "IMMUNE_TO_SLOWED_2_OR_HIGHER"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_BENEFIT_WHILE_WELL_BLOODIED",
		      "target": "giantborn_giants_resolve"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "REDUCE_DAMAGE_TAKEN_ONCE_PER_COMBAT",
		      "value": "Might_or_Agility"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "MODIFY_THROW_DISTANCE_CREATURES",
		      "value": 1
		   },
		   {
		      "type": "MODIFY_THROW_DISTANCE_OBJECTS",
		      "value": 5
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ADV_ON_CHECKS",
		      "target": "Throw_Creatures"
		   },
		   {
	...
	},
	{
		...
		effects: [
		   {
		      "type": "USE_ATTRIBUTE_FOR_JUMP_DISTANCE_FALLING_DAMAGE",
		      "target": "Might"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Shove_or_Grapple_As_Minor_Action_OncePerCombat"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "MODIFY_MOVEMENT_TO_STAND_UP",
		      "value": 4
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_DISADV_ON_CHECKS",
		      "target": "Agility_Checks"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Healing_Touch_OncePerCombat_1AP"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Emit_Bright_Light_5Space_Radius_AtWill"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Heal_Over_Time_OncePerCombat_1AP_1MP"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Blind_Target_OncePerCombat_1AP"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_VULNERABILITY_STATIC",
		      "target": "Umbral",
		      "value": 1
		   }
		]
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Snuff_Out_Mundane_Light_Source_1AP"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ADV_ON_INFLUENCE_CHECK_ONCE_PER_LONG_REST",
		      "condition": "trying_to_deceive"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_SPELL_KNOWN",
		      "value": "Sorcery_Cantrip"
		   },
		   {
		      "type": "SET_SORCERY_ENERGY_TYPE",
		      "target": "Fiendish_Origin"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Intimidate_As_Minor_Action_OncePerCombat"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Charm_Target_OncePerLongRest_1AP"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "REDUCE_HP_REGAINED_FROM_DIVINE_SOURCES",
		      "value": 1
		   }
		]
	},
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Echolocation_1AP_10Space_1Round"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "target": "manual_review_needed",
		      "value": "[{ type: 'MODIFY_PD', value: 1, condition: 'not_wearing_armor' }]"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_CLIMB_SPEED_EQUAL_TO_SPEED"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Walk_On_Vertical_Surfaces_Ceilings"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_BURROW_SPEED_HALF_SPEED"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "MODIFY_JUMP_DISTANCE",
		      "value": 2
		   },
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Jump_As_Minor_Action"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_FLY_SPEED_EQUAL_TO_SPEED"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "IGNORE_OPPORTUNITY_ATTACKS_WHEN_FLY_OUT_OF_REACH"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ADV_ON_STEALTH_CHECKS_WHILE_FLYING"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "target": "manual_review_needed",
		      "value": "[{ type: 'MODIFY_AD', value: 1, condition: 'not_wearing_armor' }]"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_PREHENSILE_APPENDAGE"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ADV_ON_STEALTH_CHECKS_WHILE_MOTIONLESS"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ADV_ON_STEALTH_CHECKS_WHILE_IN_DARKNESS"
		   }
		]
	},
	{
		...
		effects: [
		   ...
		   {
		      "type": "GRANT_RESISTANCE_TO_EXHAUSTION",
		      "condition": "cold_temperatures"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Natural_Projectile_Ranged_Attack"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_PROPERTY_TO_NATURAL_WEAPON",
		      "target": "Concealable"
		   }
		]
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Venomous_Natural_Weapon_Impaired"
		   }
		]
	},
	{
	...
	},
	{
		...
		effects: [
		   {
		      "type": "GRANT_ABILITY",
		      "value": "Mimic_Simple_Sounds_Short_Phrases"
		   }
		]
	},
	{
