...
export const psiBolt: Spell = {
  ...
  effects: [
    { title: "Spell Attack", description: "You can make a Spell Check against the PD of a target within range. Hit: The target takes 2 Psychic damage." },
    { title: "Headache", description: "You tear into the mind of a creature you can see within range and give them a mild headache for 1 minute." }
  ],
  ...
  enhancements: [
    ...
    { type: "AP", cost: 1, name: "Dazed", description: "The target makes a Mental Save. Failure: Target becomes Dazed (DisADV on Mental Checks) on the next Mental Check it makes before the end of your next turn." }
  ]
};
